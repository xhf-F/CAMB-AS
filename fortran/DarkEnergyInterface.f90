    ...
    type, extends(TDarkEnergyModel) :: TDarkEnergyEqnOfState
        ...
        integer :: astress_model = 1 !KZ
        real(dl) :: astress_p1 = 0.0 !KZ
        real(dl) :: astress_p2 = 0.0 !KZ
        real(dl) :: astress_p3 = 0.0 !KZ
        real(dl) :: astress_p4 = 0.0 !KZ
    ...
    subroutine PerturbedStressEnergy(this, dgrhoe, dgqe, dgpie, &!KZ
    ...
    subroutine PerturbationEvolve(this, ayprime, w, w_ix, a, adotoa, k, z, y, dgrho, dgrho_de, dgpi_de, grho, grhov_t) !KZ
    class(TDarkEnergyModel), intent(in) :: this
    real(dl), intent(inout) :: ayprime(:)
    real(dl), intent(in) :: a,adotoa, k, z, y(:), w, dgrho, dgrho_de, dgpi_de, grho, grhov_t !KZ
    integer, intent(in) :: w_ix
    ...
    this%is_cosmological_constant = .FALSE. !KZ: false it to be ppf or fluid, need to be careful with fluid
