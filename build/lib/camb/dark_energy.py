...
class DarkEnergyEqnOfState(DarkEnergyModel):
    ...
    _fields_ = [
        ...
        ("astress_model", c_int, "DE astress model"), #KZ
        ("astress_p1", c_double, "astress parameter 1"), #KZ
        ("astress_p2", c_double, "astress parameter 2"), #KZ
        ("astress_p3", c_double, "astress parameter 3"), #KZ
        ("astress_p4", c_double, "astress parameter 4") #KZ
        ]

    _methods_ = [('SetWTable', [numpy_1d, numpy_1d, POINTER(c_int)])]

    def set_params(self, w=-1.0, wa=0, cs2=1.0, astress_model = 1, astress_p1 = 0.0, astress_p2 = 0.0, astress_p3 = 0.0, astress_p4 = 0.0): #KZ
        """
        ...
        # KZ start
        self.astress_model = astress_model
        self.astress_p1 = astress_p1
        self.astress_p2 = astress_p2
        self.astress_p3 = astress_p3
        self.astress_p4 = astress_p4
        # KZ end
